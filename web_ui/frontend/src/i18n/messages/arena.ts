...
export const arena: { zh: Record<string, string>; en: Record<string, string> } = {
  zh: {
    ...
    'arena.plotRangeHint': '按记录位置 0..{value}',
    ...
    'arena.plotSummary': '模型贴合摘要（误差 = pilot − 用户）',
    'arena.metricAngle': '角度',
    'arena.metricThrottle': '油门',
    'arena.metricMae': 'MAE {v}',
    'arena.metricRmse': 'RMSE {v}',
    'arena.metricBias': '偏差 {v}',
    'arena.metricMaxErr': 'max|err| {v}',
    'arena.metricFrames': '{n} 帧',
    'arena.metricNoData': '无数据',
  },
  en: {
    'arena.pageTitle': 'Pilot Arena',
    ...
    'arena.plotRangeHint': 'By record position 0..{value}',
    'arena.plotUserAngle': 'user angle',
    'arena.plotPilotAngle': 'pilot angle',
    'arena.plotUserThrottle': 'user throttle',
    'arena.plotPilotThrottle': 'pilot throttle',
    ...
    'arena.plotSummary': 'Fit summary (error = pilot − user)',
    'arena.metricAngle': 'Angle',
    'arena.metricThrottle': 'Throttle',
    'arena.metricMae': 'MAE {v}',
    'arena.metricRmse': 'RMSE {v}',
    'arena.metricBias': 'bias {v}',
    'arena.metricMaxErr': 'max|err| {v}',
    'arena.metricFrames': '{n} frames',
    'arena.metricNoData': 'no data',
  },
};
