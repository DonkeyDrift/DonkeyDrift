...
export const trainer: { zh: Record<string, string>; en: Record<string, string> } = {
  zh: {
    ...
    'trainer.loadToCarSent': '已选定模型，车端将重启后生效',
    ...
    'trainer.importModelFile': '模型文件（.tflite / .h5 / .zip）',
    'trainer.importLossImage': 'Loss 曲线图（可选，PNG/JPG）',
    'trainer.importMetaJson': '训练元数据（可选，JSON）',
    'trainer.importConfirm': '导入',
  ...
  en: {
    ...
    'trainer.loadToCarSent': 'Model selected; the car will restart to apply it',
    ...
    'trainer.importModelFile': 'Model file (.tflite / .h5 / .zip)',
    'trainer.importLossImage': 'Loss chart (optional, PNG/JPG)',
    'trainer.importMetaJson': 'Training metadata (optional, JSON)',
    'trainer.importConfirm': 'Import',
