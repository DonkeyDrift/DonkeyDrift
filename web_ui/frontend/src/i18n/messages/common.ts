...
export const common: { zh: Record<string, string>; en: Record<string, string> } = {
  zh: {
    ...
    'common.loading': '加载中',
    'common.dataState.error': '数据加载失败，请重试',
    'common.dataState.retry': '重试',
    'common.themeSwitcher.toLight': '切换到浅色主题',
    'common.themeSwitcher.toDark': '切换到深色主题',
    'common.languageSwitcher.toEn': 'Switch to English',
    'common.languageSwitcher.toZh': '切换到中文',
    // ConfigLoader
    ...
    'common.configLoader.pathPlaceholder': '配置路径，例如 ~/projects/mycar',
  ...
  en: {
    ...
    'common.nav.trainer': 'Trainer',
    'common.nav.drive': 'Drive',
    'common.dataState.error': 'Couldn\u2019t load data. Try again.',
    'common.dataState.retry': 'Retry',
    ...
    'common.configLoader.pathPlaceholder': 'Config path, e.g. ~/projects/mycar',
