...
export const common: { zh: Record<string, string>; en: Record<string, string> } = {
  zh: {
    ...
    // ZCode 入口行为已改为远程控制链接（凭证仅存 localStorage，不入库）
    'common.enterButtons.zcodeTitle': '单击打开 ZCode 远程控制，双击更新链接',
    'common.enterButtons.zcodePrompt': '请粘贴 ZCode 远程控制链接（形如 https://zcode.z.ai/remote/v4，由 ZCode 桌面端生成）',
    'common.enterButtons.zcodeInvalid': '链接无效：必须以 https:// 开头，未保存',
  ...
  en: {
    ...
    'common.enterButtons.zcode': 'ZCode',
    // The ZCode entry now opens the Remote Control link (a credential kept only in localStorage, never in the repo)
    'common.enterButtons.zcodeTitle': 'Click to open ZCode Remote Control, double-click to update the link',
    'common.enterButtons.zcodePrompt': 'Paste the ZCode Remote Control link (e.g. https://zcode.z.ai/remote/v4, generated by the ZCode desktop app)',
    'common.enterButtons.zcodeInvalid': 'Invalid link: it must start with https:// — not saved',
    'common.enterButtons.donkey': 'Donkey',
