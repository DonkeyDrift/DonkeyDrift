...
export const common: { zh: Record<string, string>; en: Record<string, string> } = {
  zh: {
    ...
    'common.enterButtons.cCode': 'C Code',
    'common.enterButtons.cCodeTitle': '在网页终端中启动 Claude Code（新标签页打开）',
    'common.enterButtons.cCodeStarting': '启动中…',
    'common.enterButtons.cCodeFailed': '打开 C Code 失败：{message}',
    'common.enterButtons.cCodeNetworkError': '网络错误或请求超时',
  ...
  en: {
    ...
    'common.enterButtons.cCode': 'C Code',
    'common.enterButtons.cCodeTitle': 'Launch Claude Code in a web terminal (opens in a new tab)',
    'common.enterButtons.cCodeStarting': 'Starting…',
    'common.enterButtons.cCodeFailed': 'Failed to open C Code: {message}',
    'common.enterButtons.cCodeNetworkError': 'Network error or request timed out, please retry',
    'common.enterButtons.dsh': 'DeepSeek Harness',
