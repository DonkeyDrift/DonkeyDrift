      ...
      <header className="bg-zinc-950 sticky top-0 z-50">
        <div className="px-3">
          <div className="h-14 flex items-center">
            {/* 标题左侧 logo：与 Donkey 启动页（8090）headerLogo 同源图标 —— 32×32、rounded-lg(8px)、无外边框、与标题 gap 12px */}
            <div className="font-bold text-xl lg:mr-8">
              {/* logo 与标题文字同包一个链接（Issue #179）：点击任意一处均可跳转官网，文字继承主题色无链接默认样式 */}
              <a href="https://www.donkeydrift.com" target="_blank" rel="noopener" className="flex items-center gap-3"><img src="/logo.png" alt="DonkeyDrifter" className="w-8 h-8 rounded-lg" />DonkeyDrifter</a>
            </div>
